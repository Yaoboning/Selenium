...
driver.find_element_by_xpath(".//*[@id='sidebar']/ul/li[4]/a/span").click()
driver.find_element_by_xpath(".//*[@id='submenuc21df892-667e-48bf-b70f-7c1c4156a986']/li[2]/a/span").click()
